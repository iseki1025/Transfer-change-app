...
$hospitalTel = $config['hospital_tel'] ?: '00-0000-0000';
$pharmacyName = $config['pharmacy_name'] ?: '○○薬局';

// 日付フォーマット
$targetDateStr = '';
if ($row['target_date']) {
    $d = new DateTime($row['target_date']);
    $wd = ['日', '月', '火', '水', '木', '金', '土'][$d->format('w')];
    $targetDateStr = $d->format('n月j日') . " ({$wd})";
}
    ...
    <div class="page-container">
        ...
        <div class="row">
            <div style="width: 60%">
                ...
                <div class="value" style="font-size: 18pt; font-weight: 700;"><?php echo h($pharmacyName); ?> 御中</div>
            </div>
        ...
        <div class="main-msg">
            <?php if ($eventType === '入院'): ?>
                入院のため、<span class="highlight"><?php echo $targetDateStr; ?></span> より<br>配薬を <span
                    class="highlight">停止</span> してください。
            <?php elseif ($eventType === '退院'): ?>
                退院のため、<span class="highlight"><?php echo $targetDateStr; ?></span> より<br>配薬を <span
                    class="highlight">再開</span> してください。
            <?php elseif ($eventType === '永眠'): ?>
                <span class="highlight"><?php echo $targetDateStr; ?></span> にご永眠されました。<br>配薬を <span
